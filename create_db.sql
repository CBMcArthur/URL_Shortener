...
--
-- Host: localhost    Database: cbmcarth_url_shortener
-- ------------------------------------------------------
...
CREATE TABLE `log` (
  ...
  `url_short_id` int(11) NOT NULL,
  `action` varchar(255) NOT NULL,
  `date_occurred` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
